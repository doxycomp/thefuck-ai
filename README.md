...
> **thefuck-ai** — This repository is an independent continuation of [nvbn/thefuck](https://github.com/nvbn/thefuck). It is not a fork; the codebase was copied to allow separate development and evolution (e.g. AI-assisted corrections) from a clear starting point.
